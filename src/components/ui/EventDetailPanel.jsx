      ...
      <div className="fixed top-0 right-0 h-full w-full max-w-sm bg-white shadow-2xl z-50 flex flex-col animate-slide-from-right dark:bg-gray-800" dir="rtl">
        ...
        <div className="px-5 py-4 border-t border-gray-100 flex gap-2 dark:border-gray-700">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 text-sm text-gray-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 px-3 py-2.5 rounded-xl transition-[background-color] duration-150 font-medium active:scale-[0.96] dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700"
          >
            <Calendar size={14} />
            יומן (.ics)
          </button>
