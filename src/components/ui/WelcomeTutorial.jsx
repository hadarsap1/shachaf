...
const STEPS = [
  {
    ...
    body: 'פלטפורמת הקליטה של הקהילה — כאן תמצאו את כל המידע, המשימות והאירועים במקום אחד.',
  },
  {
    emoji: '🏠',
    title: 'מסך הבית',
  ...
  },
  {
    emoji: '🚀',
    title: 'מוכנים? יאללה!',
    body: 'זהו! אפשר תמיד לגשת לעזרה דרך התפריט. בהצלחה בקליטה ובברוכים הבאים לקהילת שחף! 💙',
  },
]
