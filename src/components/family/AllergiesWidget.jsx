...
const MODES = {
  ...
  shared: {
    ...
    rules: [
      { ok: false, text: 'מכיל אחד מהאלרגנים' },
      { ok: false, text: '"עלול להכיל" — גם אסור' },
    ],
  },
}
...
const FAQS = [
  ...
  },
  {
    ...
    a: '"מכיל" — האלרגן הוא רכיב במוצר, ולכן אסור בכל מצב. "עלול להכיל" — המוצר יוצר בסביבה שיש בה את האלרגן. בקופסה האישית זה מותר; במזון שמגישים לכולם זה אסור, כי גם הילד האלרגי עלול לקחת ממנו.',
  },
  {
    q: 'מותר להביא "עלול להכיל" לאירוע או לשולחן משותף?',
    a: 'לא. כל מה שמוגש לכולם — כיבוד לכיתה, ימי הולדת, ירידים ואירועי קהילה — צריך להיות נקי גם מ"עלול להכיל".',
  },
  {
  ...
  {
    q: 'במבה?',
    a: 'במבה רגילה מכילה בוטנים — אסורה. מוצרים שמסומנים רק "עלול להכיל בוטנים", כמו במבה אדומה או צ\'יטוס איקסים ועיגולים — מותרים.',
  },
  {
    q: 'לחמניות ומאפים מהמאפייה?',
    a: 'רוב מוצרי המאפייה "עלולים להכיל" שומשום גם כשאין עליהם שומשום. בקופסה האישית — בסדר. לשולחן משותף — עדיף מוצר ארוז עם סימון ברור.',
  },
  {
    q: 'אוכל ביתי לשולחן משותף?',
    a: 'שימו לב: אם במטבח יש בוטנים, שומשום או אגוזים — גם מאכל ביתי נחשב "עלול להכיל". במקרה של ספק, עדיף להביא משהו אחר.',
  },
  {
  ...
  {
    q: 'סויה ואדממה?',
    a: 'סויה אינה ברשימת האלרגנים — מותר.',
  },
  {
  ...
  },
  {
    ...
    a: 'לצוות בית הספר — הוא הגורם המוסמך. הכלל הפשוט: אם לא בטוחים, לא מביאים.',
  },
]
