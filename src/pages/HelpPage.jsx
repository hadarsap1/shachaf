...
const SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: 'מה זו משפחה קולטת?',
        a: 'משפחה קולטת היא משפחה ותיקה בשחף שמתנדבת ללוות משפחה חדשה בתהליך הקליטה. הם יכולים לעזור עם שאלות, להכיר את הקהילה ולהיות נקודת הקשר הראשונה.',
      },
      {
        q: 'איך יוצרים קשר עם המשפחה הקולטת?',
        a: 'בדף "בית" תמצאו את פרטי הקשר של המשפחה הקולטת. ניתן לפנות אליהם ישירות בטלפון או בוואטסאפ. בחלק מהמשימות יש כפתור "שלח וואטסאפ" ישיר.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'בכרטיס האירוע לחצו "הוספה ליומן Google" — ייפתח יומן Google עם כל הפרטים, בשעון ישראל. לחלופין, "הורדה ליומן (.ics)" מוריד קובץ תואם לכל יומן.',
      },
      {
