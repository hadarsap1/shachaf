...
const SECTIONS = [
  {
    ...
    faqs: [
      ...
      {
        q: 'שלחתי הודעה או דיווחתי על תקלה — איפה אראה את התשובה?',
        a: 'בדף "צור קשר". שם מופיעות ההודעות ששלחתם עם התשובות של הצוות, וגם הדיווחים על תקלות עם המענה עליהם. כשמגיעה תשובה חדשה מופיעה שורה בדף הבית ("קיבלת תשובה מצוות שחף") וסימון ליד "צור קשר" בתפריט — אפשר ללחוץ ולקרוא.',
      },
      {
